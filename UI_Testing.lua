...
if game.PlaceId == 17399149936 then
    print("Executed!")
    print("Status", "Loading Setup")
else
...
function GetUi()
    ...
    Library.DestroyUI = function()
        if game.CoreGui:FindFirstChild("Banana Cat Hub GUI") then for i, v in ipairs(game.CoreGui:GetChildren()) do if string.find(v.Name,  "Banana Cat Hub") then v:Destroy() getgenv().ProjectHub = false end end end
    end
