...
local rconsolelog = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/yPolar7/Project/main/Custom%20Lua%20Functions/rconsolelog.lua"))();
...
local espInit = loadstring(game:HttpGet("https://raw.githubusercontent.com/yPolar7/Project/main/Handlers/EspTab.lua"))()
...
local CombatTab = Tabs["Main Tab"]:AddLeftGroupbox("Main");
local MiscTab = Tabs["Main Tab"]:AddRightGroupbox("Misc");
...
local HeadChance = 25;
CombatTab:AddSlider("Head Chance", {
...
local OldRayCast; OldRayCast = hookfunction(Raycast.cat, function(...)
    local Args = {...};
...
ThemeManager:SetFolder("Project");
SaveManager:SetFolder("Project/Anime Souls Simulator");
